export default function FlowDemoPage() {
  return (
    <div className="min-h-screen bg-[#f4f7fa] flex flex-col items-center justify-center p-8">
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold text-[#1e3a5f]">Trade Container — Platform Flow</h1>
        <p className="text-gray-500 mt-2">How clients, the platform and transporters connect</p>
      </div>
        ...
        >
          <defs>
            <style>{`
              ...
              .tc-heading { font-family: 'Inter', sans-serif; font-weight: 700; fill: #1e3a5f; }
              ...
              .tc-text-accent { font-family: 'Inter', sans-serif; font-weight: 600; fill: #3b82f6; }
              .tc-badge-text { font-family: 'Inter', sans-serif; font-weight: 700; fill: #ffffff; }
            `}</style>

            {/* Calea principala: Client → Platforma → Transporter (loop mare) */}
            <path
              id="mainPath"
            ...
            {/* Calea secundara: Client → Platforma (shortcut diagonal) */}
            <path
              id="secondaryPath"
            ...
            {/* Calea tertiara 1: Platforma → Tracking */}
            <path
              id="tertiaryPath1"
            ...
            {/* Calea tertiara 2: Platforma → CMR Digital */}
            <path
              id="tertiaryPath2"
          ...
          {/* === PUNCT ANIMAT PRINCIPAL (container albastru) === */}
          <g id="moving-dot">
            <animateMotion dur="18s" repeatCount="indefinite">
              <mpath href="#mainPath" />
            </animateMotion>
            <rect x="-22" y="-22" width="44" height="44" rx="10" fill="#1e3a5f" />
            <text x="0" y="7" textAnchor="middle" fontSize="20">🚛</text>
          </g>

          {/* === PUNCT ANIMAT SECUNDAR (oferta) === */}
          <g id="secondary-dot">
            <animateMotion dur="5s" repeatCount="indefinite">
              <mpath href="#secondaryPath" />
            </animateMotion>
            <circle r="13" fill="#3b82f6" opacity="0.9" />
          ...
          {/* ======================================================= */}
          {/* CARD 1: CLIENT / SHIPPER (stanga sus) */}
          {/* ======================================================= */}
          <g transform="translate(12, 60)">
            <rect width="240" height="175" rx="14" fill="white" stroke="#3b82f6" strokeWidth="2.5" />
            ...
            {/* Badge */}
            <rect x="30" y="110" width="180" height="32" rx="16" fill="#3b82f6" />
            <text x="120" y="131" textAnchor="middle" className="tc-badge-text" fontSize="12">✓ KYC Verified</text>
          </g>

          {/* ======================================================= */}
          {/* CARD 2: CERERI TRANSPORT (stanga mijloc) */}
          {/* ======================================================= */}
          <g transform="translate(12, 300)">
            <rect width="240" height="140" rx="14" fill="white" stroke="#1e3a5f" strokeWidth="2" strokeDasharray="6,6" />
            <text x="120" y="38" textAnchor="middle" className="tc-heading" fontSize="15">📦 Cereri Transport</text>
            <text x="120" y="62" textAnchor="middle" className="tc-heading" fontSize="13">(Shipment Requests)</text>
            <text x="120" y="90" textAnchor="middle" className="tc-text" fontSize="11">Post route, container type,</text>
            <text x="120" y="108" textAnchor="middle" className="tc-text" fontSize="11">weight & date</text>
          </g>

          {/* ======================================================= */}
          {/* CARD 3: RETEAUA MEA (center stanga) */}
          {/* ======================================================= */}
          <g transform="translate(300, 275)">
            <rect width="210" height="120" rx="14" fill="white" stroke="#1e3a5f" strokeWidth="2" strokeDasharray="6,6" />
          ...
          {/* ======================================================= */}
          {/* CARD 4: AI MATCHING (stanga jos) */}
          {/* ======================================================= */}
          <g transform="translate(170, 520)">
            <rect width="210" height="120" rx="14" fill="#3b82f6" />
          ...
          <g transform="translate(400, 345)">
            <rect x="20" y="0" width="180" height="36" rx="18" fill="#1e3a5f" />
            <text x="110" y="23" textAnchor="middle" className="tc-text-white" fontSize="12">🔗 Broadcast Offer</text>
          </g>

          {/* ======================================================= */}
          {/* CARD 5: PLATFORMA TRADE CONTAINER (centru) */}
          {/* ======================================================= */}
          <g transform="translate(430, 390)">
            <rect width="280" height="210" rx="22" fill="#1e3a5f" />
          ...
          {/* ======================================================= */}
          {/* CARD 6: RATING & OFFERS (dreapta jos) */}
          {/* ======================================================= */}
          ...
          {/* ======================================================= */}
          {/* CARD 7: GESTIUNE OFERTE (dreapta mijloc) */}
          {/* ======================================================= */}
          <g transform="translate(750, 220)">
            <rect width="330" height="220" rx="14" fill="white" stroke="#1e3a5f" strokeWidth="2" strokeDasharray="6,6" />
          ...
          {/* ======================================================= */}
          {/* CARD 8: TRANSPORT ORDER (dreapta sus) */}
          {/* ======================================================= */}
          <g transform="translate(780, 50)">
            <rect width="210" height="130" rx="14" fill="white" stroke="#1e3a5f" strokeWidth="2" strokeDasharray="6,6" />
          ...
          {/* ======================================================= */}
          {/* CARD 9: TRACKING (top dreapta extern) */}
          {/* ======================================================= */}
          <g transform="translate(1020, 25)">
            <rect width="165" height="100" rx="12" fill="white" stroke="#1e3a5f" strokeWidth="2" strokeDasharray="6,6" />
            ...
            <text x="16" y="76" className="tc-text" fontSize="10">• Real-time updates</text>
          </g>

          {/* ======================================================= */}
          {/* CARD 10: CMR DIGITAL (dreapta extern jos) */}
          {/* ======================================================= */}
          ...
          {/* ======================================================= */}
          {/* CARD TRANSPORTER (dreapta, simetric cu Client) */}
          {/* ======================================================= */}
      ...
      <p className="text-xs text-gray-400 mt-6">
        Trade Container — European Freight Exchange Platform Flow Demo
      </p>
    </div>
  )
}
