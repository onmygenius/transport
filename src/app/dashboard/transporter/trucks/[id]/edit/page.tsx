...
import { getTruckById, updateTruckAvailability } from '@/lib/actions/trucks'
...
export default function EditTruckPage() {
  ...
  const loadTruck = async () => {
    ...
    if (!result.success || !result.data) {
      setError(result.error || 'Failed to load truck')
      setLoading(false)
      return
    }
    ...
    setFormData({
      ...
      destination_city: truck.destination_city || '',
      destination_country: truck.destination_country || '',
      available_from: truck.available_from?.split('T')[0] || '',
      available_until: truck.available_until?.split('T')[0] || '',
  ...
  if (loading) {
    return (
      <div className="flex flex-col min-h-screen overflow-y-auto">
        <TransporterHeader title="Edit Truck" />
      ...
      <div className="flex flex-col min-h-screen overflow-y-auto">
        ...
        <main className="flex-1 flex items-center justify-center p-6">
          <div className="text-center max-w-md">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-2">Truck Updated!</h2>
            <p className="text-gray-500 mb-6">Your truck availability has been updated successfully.</p>
  ...
  return (
    <div className="flex flex-col min-h-screen overflow-y-auto">
      <TransporterHeader title="Edit Truck Availability" subtitle="Update your truck details" />
