...
export default async function TransporterSupportPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen overflow-y-auto">
      <TransporterHeader title="Support" subtitle="Get in touch with our team" />
          ...
          <CardContent className="space-y-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a href="mailto:info@trade-container.com" className="text-base font-semibold text-gray-900 hover:text-blue-600 transition-colors">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a href="tel:+40729368052" className="text-base font-semibold text-gray-900 hover:text-blue-600 transition-colors">
                  +40729 368 052
                </a>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a href="https://wa.me/40729368052" target="_blank" rel="noopener noreferrer" className="text-base font-semibold text-gray-900 hover:text-blue-600 transition-colors">
                  +40729 368 052
                </a>
