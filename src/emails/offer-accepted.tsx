      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={content}>
            <Text style={heading}>Congratulations! Offer Accepted! 🎊</Text>
            ...
            <Text style={paragraph}>
              Great news! <strong>{clientName}</strong> ({clientCountry}) has accepted your offer.
            </Text>
            ...
            <Section style={detailsBox}>
              ...
              <Text style={priceText}>
                Agreed Price: <span style={priceAmount}>{currency} {price}</span>
              </Text>
            </Section>
            ...
            <Section style={contactBox}>
              <Text style={contactTitle}>Client Contact Information:</Text>
              <Text style={contactInfo}>📞 Phone: {clientPhone}</Text>
              <Text style={contactInfo}>✉️ Email: {clientEmail}</Text>
            </Section>

            <Section style={buttonContainer}>
              <Button style={button} href={`${baseUrl}/dashboard/transporter/jobs`}>
...
const detailsTitle = { fontSize: '14px', fontWeight: '600', color: '#6b7280', textTransform: 'uppercase' as const, letterSpacing: '0.5px', margin: '0 0 12px' }
...
const priceText = { fontSize: '16px', color: '#374151', margin: '16px 0 0', textAlign: 'center' as const }
const priceAmount = { fontSize: '32px', fontWeight: 'bold', color: '#059669', display: 'block', marginTop: '8px' }
