...
interface TruckNewAvailableEmailProps {
...
export default function TruckNewAvailableEmail(props: TruckNewAvailableEmailProps) {
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={content}>
            <Text style={heading}>New Truck Available! 🚛</Text>
            <Text style={paragraph}>Hello <strong>{props.recipientName}</strong>,</Text>
            <Text style={paragraph}><strong>{props.transporterName}</strong> has a truck available on your route.</Text>
            <Section style={detailsBox}>
              <table style={detailsTable}>
                <tr><td style={detailsLabel}>Route:</td><td style={detailsValue}>{props.route}</td></tr>
                <tr><td style={detailsLabel}>Equipment:</td><td style={detailsValue}>{props.equipmentType}</td></tr>
                <tr><td style={detailsLabel}>Available from:</td><td style={detailsValue}>{props.availableFrom}</td></tr>
                <tr><td style={detailsLabel}>Price:</td><td style={detailsValue}>{props.currency} {props.price}</td></tr>
              </table>
            </Section>
            <Section style={buttonContainer}>
              <Button style={button} href={`${baseUrl}/dashboard/client/transporters/${props.truckId}`}>
                View Details
              </Button>
            </Section>
          </Section>
