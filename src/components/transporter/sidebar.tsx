...
export function TransporterSidebar({ companyName, email, unreadMessagesCount = 0, isOpen = false, onClose }: TransporterSidebarProps) {
  ...
  return (
    <>
      ...
      <aside className={cn(
        "fixed md:static inset-y-0 left-0 z-50 flex h-screen w-64 shrink-0 flex-col border-r border-gray-200 bg-white transition-transform duration-300",
