...
export function EuropeMap({ 
  ...
  // Proiecție specifică pentru Europa
  // Europa: lat între 35° (sud) și 71° (nord), lng între -10° (vest) și 40° (est)
  const projectPoint = (lat: number, lng: number) => {
    const europeMinLat = 35;
    const europeMaxLat = 71;
    const europeMinLng = -10;
    const europeMaxLng = 40;
    
    // Normalizăm coordonatele la viewBox-ul nostru (800x400)
                  ...
                  >
                    ...
                    >
                      <div className="flex items-center justify-center h-full">
                        <span className="text-[10px] font-medium px-1 py-0.5 rounded bg-white/90 dark:bg-black/90 text-black dark:text-white border border-gray-200 dark:border-gray-700 shadow-sm">
                          {dot.start.label}
                        </span>
                      </div>
                    </foreignObject>
