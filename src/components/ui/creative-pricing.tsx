    ...
    return (
        <div className="w-full max-w-6xl mx-auto px-4">
            ...
            <div className="mb-8 max-w-3xl mx-auto">
                <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-emerald-500 to-emerald-600 p-6 shadow-2xl">
                    <div className="relative z-10">
                        ...
                        <div className="bg-zinc-900 rounded-2xl p-4 mb-4">
                            <p className="text-4xl font-bold text-white mb-1">30 Days Free</p>
                            <p className="text-base text-emerald-50">No credit card required</p>
                        </div>
                        <div className="space-y-2 mb-4">
                            ...
                            <div className="flex items-center gap-2 text-white">
                                <Check className="w-4 h-4 shrink-0" />
                                <span className="text-sm">Real-time chat and documents</span>
                            </div>
                            <div className="flex items-center gap-2 text-white">
                                <Check className="w-4 h-4 shrink-0" />
                        ...
                        <Button
                            ...
                            className="w-full h-12 text-base font-bold bg-white text-emerald-600 hover:bg-emerald-50 shadow-xl hover:shadow-2xl transition-all duration-300"
                        >
