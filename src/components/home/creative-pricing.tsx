...
const clientTiers: PricingTier[] = [
  {
    ...
    color: 'emerald',
    limit: 'Up to 4 shipments/month',
    features: [
      'Post up to 4 active shipment requests',
  ...
  },
  {
    ...
    color: 'blue',
    limit: 'Up to 8 shipments/month',
    popular: true,
    features: [
      'Post up to 8 active shipment requests',
      'Access to all verified transporters',
      'Real-time chat per shipment',
      'Digital CMR documents',
  ...
  },
  {
    ...
    color: 'emerald',
    limit: 'Up to 12 shipments/month',
    features: [
      'Post up to 12 active shipment requests',
      'Access to all verified transporters',
      'Real-time chat per shipment',
