...
const clientTiers: PricingTier[] = [
  {
    ...
    price: 19.99,
    description: 'Up to 4 shipments/month. Perfect for small businesses.',
    color: 'emerald',
    priceId: 'price_1TASbp0dqWRNGixPqAoh7aKf',
    features: [
      'Post up to 4 shipment requests',
  ...
  },
  {
    ...
    price: 34.99,
    description: 'Up to 8 shipments/month. For growing companies.',
    color: 'blue',
    popular: true,
    priceId: 'price_1TAScM0dqWRNGixPJ3IlWAut',
    features: [
      'Post up to 8 shipment requests',
      'Access to all verified transporters',
      'Real-time chat per shipment',
  ...
  },
  {
    ...
    price: 59.99,
    description: 'Up to 12 shipments/month. For high-volume shippers.',
    color: 'emerald',
    priceId: 'price_1TAScl0dqWRNGixPZ5yVzA7d',
    features: [
      'Post up to 12 shipment requests',
      'Access to all verified transporters',
